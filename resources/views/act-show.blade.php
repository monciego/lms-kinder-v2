        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        <div class="bg-gray-50 px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 content-center">
                            <dt class="text-sm font-medium text-gray-500">Activity Name</dt>
                            <dd class="text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ $activity->activity_name }}
                            </dd>
                        </div>
